...
const CURRICULUM_SEED = [
  ...
  { guitar_type: "ukulele", category: "기초 이론", title: "우쿨렐레 각 부분 명칭", description: "헤드, 넥, 바디, 브릿지, 프렛 등 우쿨렐레 구조", order: 1, level: "beginner" },
  { guitar_type: "ukulele", category: "기초 이론", title: "튜닝 방법", description: "표준 튜닝 (G-C-E-A), 튜너 사용법", order: 2, level: "beginner" },
  { guitar_type: "ukulele", category: "기초 이론", title: "TAB 악보 읽기", description: "우쿨렐레 TAB 악보의 구조와 읽는 방법", order: 3, level: "beginner" },
  { guitar_type: "ukulele", category: "코드", title: "기본 코드 (C, Am, F, G)", description: "가장 기본이 되는 오픈 코드 4가지", order: 4, level: "beginner" },
  { guitar_type: "ukulele", category: "코드", title: "코드 체인지 연습", description: "코드 간 부드러운 전환 연습", order: 5, level: "beginner" },
  { guitar_type: "ukulele", category: "스트로크", title: "다운 스트로크", description: "기본 다운 스트로크 패턴", order: 6, level: "beginner" },
  { guitar_type: "ukulele", category: "스트로크", title: "업/다운 스트로크", description: "업다운 교차 스트로크 패턴", order: 7, level: "beginner" },
  { guitar_type: "ukulele", category: "스트로크", title: "칼립소 스트로크", description: "우쿨렐레 대표 리듬 패턴", order: 8, level: "beginner" },
  { guitar_type: "ukulele", category: "연습곡", title: "첫 번째 연습곡", description: "배운 코드와 스트로크를 활용한 첫 번째 곡", order: 9, level: "beginner" },
  { guitar_type: "ukulele", category: "연습곡", title: "두 번째 연습곡", description: "다양한 스트로크 패턴 적용 곡", order: 10, level: "beginner" },
  { guitar_type: "ukulele", category: "코드", title: "바레 코드 (Bb, Bm)", description: "바레 코드의 원리와 연습 방법", order: 11, level: "intermediate" },
  { guitar_type: "ukulele", category: "코드", title: "세븐스/어그먼트 코드", description: "7th, aug, dim 등 다양한 코드", order: 12, level: "intermediate" },
  { guitar_type: "ukulele", category: "스트로크", title: "16비트 스트로크", description: "16비트 리듬 패턴과 고스트 스트로크", order: 13, level: "intermediate" },
  { guitar_type: "ukulele", category: "핑거피킹", title: "아르페지오 기초", description: "T-1-2-3 기본 아르페지오 패턴", order: 14, level: "intermediate" },
  { guitar_type: "ukulele", category: "핑거피킹", title: "핑거피킹 패턴", description: "다양한 핑거피킹 패턴 연습", order: 15, level: "intermediate" },
  { guitar_type: "ukulele", category: "이론", title: "메이저 스케일", description: "C 메이저 스케일의 구조와 운지", order: 16, level: "intermediate" },
  { guitar_type: "ukulele", category: "이론", title: "펜타토닉 스케일", description: "마이너 펜타토닉 스케일 포지션", order: 17, level: "intermediate" },
  { guitar_type: "ukulele", category: "테크닉", title: "해머온/풀오프", description: "레가토 테크닉의 기초", order: 18, level: "intermediate" },
  { guitar_type: "ukulele", category: "연습곡", title: "핑거피킹 곡", description: "아르페지오를 활용한 곡", order: 19, level: "intermediate" },
  { guitar_type: "ukulele", category: "연습곡", title: "바레코드 활용 곡", description: "바레코드가 포함된 곡 연습", order: 20, level: "intermediate" },
  { guitar_type: "ukulele", category: "테크닉", title: "트레몰로", description: "빠른 반복 스트로크 테크닉", order: 21, level: "advanced" },
  { guitar_type: "ukulele", category: "테크닉", title: "하모닉스", description: "내추럴 하모닉스 연주법", order: 22, level: "advanced" },
  { guitar_type: "ukulele", category: "이론", title: "코드 보이싱", description: "다양한 자리 바꿈과 보이싱", order: 23, level: "advanced" },
  { guitar_type: "ukulele", category: "이론", title: "키와 조성", description: "키의 이해와 전조", order: 24, level: "advanced" },
  { guitar_type: "ukulele", category: "핑거피킹", title: "고급 핑거피킹", description: "클래시컬/재즈 핑거피킹 스타일", order: 25, level: "advanced" },
];
